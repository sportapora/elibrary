        ...
        <div>
            ...
            <form action="" method="post" class="mt-4">
                ...
                <div class="mb-3">
                    ...
                    <x-text-input placeholder="Name" id="email" class="block mt-1 w-full bg-gray-200" type="text"
                ...
                <div class="flex justify-center">
                    <button type="submit" class="bg-primary font-bold text-gray-100 rounded-2xl px-6 py-2">Send Message
                    </button>
                </div>
            </form>
        </div>
