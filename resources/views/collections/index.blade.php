...
@section('content')
    <div class="py-6 px-3 bg-[#D9D9D9]/50">
        <ul class="flex flex-col lg:flex-row gap-6">
            <li class="{{request('category') == 'novel'  ? 'bg-[#00065C] text-white' : 'bg-transparent text-gray-900 hover:bg-[#00065c] hover:text-white'}} ease-in-out transition-all duration-100 px-12 py-2 rounded-3xl">
                <a href="/collections?category=novel">Novel</a>
            </li>
            <li class="{{request('category') == 'bukuilmiah'  ? 'bg-[#00065C] text-white' : 'bg-transparent text-gray-900 hover:bg-[#00065c] hover:text-white'}} ease-in-out transition-all duration-100 px-12 py-2 rounded-3xl">
                <a href="/collections?category=bukuilmiah">Buku Ilmiah</a>
            </li>
            <li class="{{request('category') == 'komik'  ? 'bg-[#00065C] text-white' : 'bg-transparent text-gray-900 hover:bg-[#00065c] hover:text-white'}} ease-in-out transition-all duration-100 px-12 py-2 rounded-3xl">
                <a href="/collections?category=komik">Komik</a>
            </li>
            <li class="{{request('category') == 'majalah'  ? 'bg-[#00065C] text-white' : 'bg-transparent text-gray-900 hover:bg-[#00065c] hover:text-white'}} ease-in-out transition-all duration-100 px-12 py-2 rounded-3xl">
                <a href="/collections?category=majalah">Majalah</a>
            </li>
            <li class="{{request('category') == 'artikel'  ? 'bg-[#00065C] text-white' : 'bg-transparent text-gray-900 hover:bg-[#00065c] hover:text-white'}} ease-in-out transition-all duration-100 px-12 py-2 rounded-3xl">
                <a href="/collections?category=artikel">Artikel</a>
            </li>
        </ul>
